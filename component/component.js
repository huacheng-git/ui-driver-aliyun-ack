...
export default Ember.Component.extend(ClusterDriver, {
  ...
  networkPluginChange: observer('config.networkPlugin', function() {
    set(this, 'config.addons', [{ name: get(this, 'config.networkPlugin') }])
  }),
